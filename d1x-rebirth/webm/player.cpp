...
namespace uvpx
{
    ...
    Player::LoadResult  Player::load(SDL_RWops *file, int audioTrack, bool preloadFile)
    {
        return m_videoPlayer->load(file, audioTrack, preloadFile);
    }
    ...
    {
        return m_videoPlayer ? m_videoPlayer->m_state == VideoPlayer::State::Finished : false;
    }
}